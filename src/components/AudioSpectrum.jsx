...
class AudioSpectrum extends Component {
  ...
  drawSpectrum = (analyser) => {
    ...
    let drawMeter = () => {
      ...
      let array = window.StreamContext.audioByteFrequencyData().full;
  ...
  render() {
    return (
      <canvas style={{ position: 'relative', top: '-300px' }} id={this.canvasId} width={this.props.width} height={this.props.height}></canvas>
    )
  }
}
